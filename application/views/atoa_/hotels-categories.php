      ...
      <div id="bg_contents">
        ...
        <div>
          <div class="blogcontents">
            ...
            <div class="descriptions">Cambodia has a range of hotels to offer for all budgets and tastes.  Travel Asia A La Carte only work with hotels we have personally inspected and in most cases, stayed overnight to test the services.</div>
            <div class="titlebar"> <img src="<?php echo base_url();?>public/images/pointer-01.png" class="imgpointer" alt="A Touch of Asia Travel"/> Hotels <img src="<?php echo base_url();?>public/images/pointer-01.png" class="imgpointer" alt="A Touch of Asia Travel"/> </div>
            <?php
					foreach($hotels as $hotel)
					{
						...
						if ($hotel['image'] != '')
                        	echo '<a href="'.site_url("directory-hotel-in-cambodia.html/".$hotel['region_id']."/".strtolower(url_title($hotel['name']))."").'"><img width="250" height="150" alt="'.$hotel['name'].'" src="'.base_url().'upload/regions/'.$hotel['image'].'"></a>';
                        echo '<h2><a href="'.site_url("directory-hotel-in-cambodia.html/".$hotel['region_id']."/".strtolower(url_title($hotel['name']))."").'">'.$hotel['name'].'</a></h2>';
                        echo '</div>';
					}
					?>
          </div>
