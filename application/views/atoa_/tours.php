...
<meta name="keywords" content="<?php echo $keywords;?>, asian and cambodia tours destinations" />
<meta name="description" content="Asian and cambodia tours for <?php echo $description;?>" />
<title><?php echo $title;?> : Asian and cambodia tours destinations</title>
               ...
               <h1><?php echo $tour_title;?></h1>
                ...
                foreach ($tours as $tour)
				{
					...
					if ($tour['promo_option'] != 0) {
                        ...
                        echo '<div class="listDetail readmore">'.character_limiter(strip_tags($tour['intro']), 300);
