...
<meta name="keywords" content="<?php echo $description;?>, directory hotel in cambodia" />
<meta name="description" content="Hotels in <?php echo $description;?>" />
<title><?php echo $title;?> : Hotels in Cambodia</title>
        ...
        <div>
        	<div class="blogcontents">
               <h1><?php echo $hotel_title;?></h1>
				...
				{
					echo '<div class="wrapper_promo"><div class="tour_block"><a class="block_click" href="'.site_url('hotel/'.$hotel['id']).'/'.strtolower(url_title($hotel['url'])).'.html"><table><tr><td width="620px"><div class="contents_border">';
