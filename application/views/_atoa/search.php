...
$(document).ready(function() {
	...
	$('#hotelsearch').show();
	$('#toursearch').hide();
	$('#titlesearch_tour img').replaceWith('<img src="<?php echo base_url();?>public/images/pointer-02.png" class="searchpointer2" alt="A Touch of Asia Travel"/>');
	$('#titlesearch_hotel img').replaceWith('<img src="<?php echo base_url();?>public/images/pointer-01.png" class="searchpointer2" alt="A Touch of Asia Travel"/>');
	return false;
	});
	...
	$('#hotelsearch').hide();
	$('#toursearch').show();
	$('#titlesearch_tour img').replaceWith('<img src="<?php echo base_url();?>public/images/pointer-01.png" class="searchpointer2" alt="A Touch of Asia Travel"/>');
	$('#titlesearch_hotel img').replaceWith('<img src="<?php echo base_url();?>public/images/pointer-02.png" class="searchpointer2" alt="A Touch of Asia Travel"/>');
	return false;
	});
});
</script>
<div class="mainsearch">
    ...
    <div class="titlesearch">
        ...
        <img src="<?php echo base_url();?>public/images/pointer-01.png" class="searchpointer1" alt="A Touch of Asia Travel"/></a>
    </div>
   ...
   <form name="searchtour" id="searchtour" method="get" action="<?php echo site_url("find-tour")?>">
       ...
       <?php echo form_dropdown('duration', $duration, $search_duration, 'id="duration" class="search"');  ?>
        ...
        <div class="searchfind">
            <a id="titlesearch_hotel" href="#">FIND YOUR HOTEL <img src="<?php echo base_url();?>public/images/pointer-02.png" class="searchpointer2" alt="A Touch of Asia Travel"/></a>
