                    ...
                    <?php foreach ($tours as $tour) : ?>
                        <div class="blog-body row">
                            <div class="col-sm-12">
                                ...
                                <!--                                overflow: hidden;-->
                                <!--                                height: 194.116px;-->
                                <!--                                padding-top: 8.57026px;-->
                                <!--                                margin-top: 4.28513px;-->
                                <!--                                padding-bottom: 0px;-->
                                <!--                                margin-bottom: 0px;-->
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('.btn_enquire').unbind('click').click(function (e) {
                ...
                $('.enquire_from_container:not(' + target + ')').slideUp(600);
                $('.enquire_from_container:not(' + target + ')').closest('.blog-body').find('.btn_enquire').removeClass('form_visible');
