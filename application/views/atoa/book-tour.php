...
<meta name="keywords" content="Tour operator in Cambodia" />
<meta name="title" content="Luxury tours and excursions : Tour Operator in Cambodia : Travel a la carte" />
<meta name="description" content="An exclusive tour operator in Cambodia: find the best tours all over the South East Asian region" />
<title>Luxury tours and excursions : Tour Operator in Cambodia : Travel a la carte</title>
...
<script type="text/javascript">
	...
	var adults_val = "EMPTY ADULTS*"
	var captcha_val = "CAPTCHA*"
    var captcha_value = $('.captcha').attr('data-captcha');
   ...
   first_name.blur(function() {
	...
	form.submit(function(){
		if(validateLastName() & validateFirstName() & validateEmail() & validateCaptcha() & validateAdults() & validateChildren() & validateInfants() & validateArrivalDate() & validateCountry() & validateHotelCategory())
			return true
		else
			return false;
	});
	...
	function validateCaptcha(){
		//if it's NOT valid
		if(captcha.val() != captcha_value || captcha.val() == ""){
            captcha.addClass("error");
            captcha.val("Captcha not match");
			return false;
		}
		//if it's valid
		else{
      ...
      <div id="bg_contents">
        ...
        <div>
            ...
            <div class="blogContentsBookTour">
                ...
                <textarea id="message" name="message" class="boxAdditional">Would you like us to change or include anything else in your tour? Tell Travel Asia about your personal interests/special requirements so we can provide your dream holiday.</textarea>

                <div class="captcha" data-captcha="<?php print_r($captcha['word']); ?>">
                    <img src="<?php echo base_url().'captcha/'.$captcha['captcha_time'].'.jpg'; ?>" />
                    <input type="text" name="captcha" id="captcha" class="boxCaptcha" value="" placeholder="Submit the word you see"/>
                </div>
            </div>
