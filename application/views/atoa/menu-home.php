<div class="menumain">
    <ul class="menu">
        ...
        <li><a href="<?php echo site_url("tour-operator-in-cambodia.html"); ?>">Tours</a>
            <ul>
                <li class="for_colum" style="text-align:left !important;"><img alt="Tours"
        ...
        <li><a href="<?php echo site_url("directory-hotel-in-cambodia.html"); ?>">Hotels</a>
            <ul>
                <li class="for_colum"><img alt="Hotels"
        ...
        <li><a href="<?php echo site_url("tour-experts-in-cambodia.html"); ?>">EXPERIENCES</a>
            <ul>
                <li class="for_colum"><img alt="Experiences"
        ...
        <li><a href="<?php echo site_url("mice-in-cambodia.html"); ?>">MICE</a>
            <ul>
                <li class="for_colum"><img alt="Mice"
