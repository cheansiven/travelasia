...
<head>
<meta charset="utf-8">
<title>Tours Activities Managemen - Edit activity</title>
...
<div id="header-with-tabs">
  <div class="page-full-width cf">
    <ul id="tabs" class="fl">
      ...
      <li><a href="#" class="active-tab dashboard-tab">Edit activity</a></li>
    </ul>
    <!-- end tabs --> 
  ...
  <div class="page-full-width cf">
    ...
    <div> <!-- class="side-content fr" -->
      <div class="content-module">
        ...
        <div class="content-module-main cf"> <?php echo form_open_multipart('admin/activities/update', 'id="activityForm" name="activityForm"'); ?>
            ...
            <fieldset>
              <p> 
                ...
                <?php
										  ...
										  echo form_input('name',$activity->name, 'id="name" class="round default-width-input" autofocus');
										  
									    ?>
              </p>
              <?php if($activity->image != '') {?>
              <p>
              	<br><img src="<?php echo base_url();?>upload/activities/<?php echo $activity->image?>">
              </p>
              <?php } ?>
              <p>
                <?php
            ...
            <fieldset>
              <p>
                <?php 
                                        ...
                                        echo form_textarea('description',$activity->description, 'id="description" class="round full-width-textarea" autofocus'); 
										
										?>
              </p>
              <?php 
									echo form_hidden('id',$activity->id, set_value('id'));
									echo form_hidden('imageold',$activity->image, set_value('imageold'));
