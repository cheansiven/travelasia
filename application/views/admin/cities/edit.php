...
<head>
<meta charset="utf-8">
<title>City Management - Edit city</title>
...
<div id="header-with-tabs">
  <div class="page-full-width cf">
    <ul id="tabs" class="fl">
      ...
      <li><a href="<?php echo site_url("admin/cities/add");?>" class="active-tab dashboard-tab">Edit city</a></li>
    </ul>
    <!-- end tabs --> 
...
<div id="content">
  <div class="page-full-width cf">
    <div> <!-- class="side-content fr" -->
      ...
      <div class="content-module">
        ...
        <div class="content-module-main cf"> <?php echo form_open_multipart('admin/cities/update', 'id="cityForm" name="cityForm"'); ?>
            ...
            <fieldset>
              <p>
                <?php
										  ...
										  echo form_input('name',$city->name, 'id="name" class="round default-width-input" autofocus');
 ...
 echo form_dropdown('country', $country, $city->country_id, 'id="country"');  
 ...
 echo form_dropdown('attractiveness', $attractiveness, $city->attractiveness, 'id="attractiveness"');  
      //echo form_input('type', '', 'id="type"');
   ?>
              </p>
              <p>
                <?php
										  ...
										  echo form_input('lat',$city->lat, 'id="lat" class="round default-width-input" autofocus');
               ...
               <p>
                <?php
										  ...
										  echo form_input('lon',$city->lon, 'id="lon" class="round default-width-input" autofocus');
          ...
          <div class="half-size-column fr"> 
            ...
            <fieldset>
              ...
              <?php 
			  echo form_hidden('city_id',$city->id);
			echo form_hidden('imageold',$city->images, set_value('imageold'));
