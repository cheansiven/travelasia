...
<head>
<meta charset="utf-8">
<title>Cruise Management - New cruise</title>
...
<div id="header-with-tabs">
  <div class="page-full-width cf">
    <ul id="tabs" class="fl">
      ...
      <li><a href="<?php echo site_url("admin/cruises/add");?>" class="active-tab dashboard-tab">Add new cruise</a></li>
    </ul>
    <!-- end tabs --> 
  ...
  <div class="page-full-width cf">
    <div> <!-- class="side-content fr" -->
      ...
      <div class="content-module">
        ...
        <?php echo form_open_multipart('admin/cruises/store', 'id="cruiseForm" name="cruiseForm"'); ?>
