...
<head>
	<meta charset="utf-8">
	<title>Transport Management - New transport</title>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="<?php echo site_url("admin/transports/add");?>" class="active-tab dashboard-tab">Add new transport</a></li>
			</ul> 
            <!-- end tabs -->
		...
		<div class="page-full-width cf">
			...
			<div> <!-- class="side-content fr" -->
				...
				<div class="content-module">
					...
					<?php echo form_open_multipart('admin/transports/store'); ?>
								...
								<fieldset>
									...
									<p>
                                        ...
                                        <?php
										  ...
										  echo form_label('Transport Name: ', 'name');
