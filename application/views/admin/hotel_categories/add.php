...
<head>
	<meta charset="utf-8">
	<title>Hotel Category Managemen - New category</title>
...
<body>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				<li><a href="<?php echo site_url("admin/hotel_categories/");?>">Dashboard</a></li>
				<li><a href="<?php echo site_url("admin/hotel_categories/add");?>" class="active-tab dashboard-tab">Add new catergory</a></li>
			</ul> 
            <!-- end tabs -->
		...
		<div class="page-full-width cf">
			...
			<div> <!-- class="side-content fr" -->
				...
				<div class="content-module">
					...
					<?php echo form_open_multipart('admin/hotel_categories/store', 'id="categoryForm" name="categoryForm"'); ?>
