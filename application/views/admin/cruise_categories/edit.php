...
<head>
	<meta charset="utf-8">
	<title>Cruise Category Managemen - Edit category</title>
...
<body>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				<li><a href="<?php echo site_url("admin/cruise_categories/");?>">Dashboard</a></li>
		...
		<div class="page-full-width cf">
			...
			<div> <!-- class="side-content fr" -->
				...
				<div class="content-module">
					...
					<?php echo form_open_multipart('admin/cruise_categories/update', 'id="categoryForm" name="categoryForm"'); ?>
                ...
                <?php
										  ...
										  echo form_input('ordering',$category->ordering, 'id="ordering" class="round small-width-input" autofocus');
										  
									    ?>
              </p>
									<?php if($category->image != '') {?>
              <p>
              	<img src="<?php echo base_url();?>upload/cruises/categories/<?php echo $category->image?>">
              </p>
              <?php } ?>
									<p>
                                    	<?php
