...
<div id="header-with-tabs">
  <div class="page-full-width cf">
    <ul id="tabs" class="fl">
      <li><a href=""<?php echo site_url("admin/regions/");?>"" class="active-tab dashboard-tab">Dashboard</a></li>
      <li><a href="<?php echo site_url("admin/regions/add");?>">Add new region</a></li>
    </ul>
    <!-- end tabs --> 
  ...
  <div class="page-full-width cf">
    <div class="content-module">
      ...
      <div class="content-module-main">
        <p>Found <?php echo $num_results; ?> region(s) </p>
         <?php echo form_open_multipart('admin/regions/ordering','id="regionForm" name="regionForm"'); ?>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <?php 
			echo form_open_multipart('admin/regions/ordering','id="regionForm" name="regionForm"'); 
			foreach($regions as $region): 
							...
							<tr>
								...
								'</td>
								<td>'.form_input('orders['.$region->id.']',$region->ordering, 'class="small-width-input" autofocus').'</td>
								<td>
