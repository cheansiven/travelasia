...
<head>
<meta charset="utf-8">
<title>Country Management - New country</title>
...
<div id="header-with-tabs">
  <div class="page-full-width cf">
    <ul id="tabs" class="fl">
      ...
      <li><a href="<?php echo site_url("admin/countries/add");?>" class="active-tab dashboard-tab">Add new country</a></li>
    </ul>
    <!-- end tabs --> 
  ...
  <div class="page-full-width cf">
    <div> <!-- class="side-content fr" -->
      ...
      <div class="content-module">
        ...
        <div class="content-module-main cf"> <?php echo form_open_multipart('admin/countries/store'); ?>
            ...
            <fieldset>
              <p> 
                ...
                <?php
										  ...
										  echo form_label('Country Name: ', 'name').'<br>';
