...
<div id="header-with-tabs">
  <div class="page-full-width cf">
    <ul id="tabs" class="fl">
      <li><a href="<?php echo site_url("admin/tours/");?>" class="active-tab dashboard-tab">Dashboard</a></li>
      <li><a href="<?php echo site_url("admin/tours/add");?>">Add new tour</a></li>
    </ul>
    <!-- end tabs --> 
  ...
  <div class="page-full-width cf">
    <div class="content-module">
      ...
      <div class="content-module-main">
        <p>Found <?php echo $num_results; ?> tour(s) </p>
        <?php echo form_open_multipart('admin/tours/ordering','id="regionForm" name="regionForm"'); ?>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
			...
			foreach($tours as $tour): 
				...
				<tr>
					...
					echo '<td>'.form_input('orders['.$tour->id.']',$tour->ordering, 'class="small-width-input" autofocus').'</td>';
					echo '</td><td>';
					echo '<a href="'.site_url("admin/tours/meta?id=$tour->id").'">Edit</a>';
					echo '</td><td>
						<a href="'.site_url("admin/tours/edit?id=$tour->id").'" class="table-actions-button ic-table-edit"></a>
						<a onClick="return window.confirm(\'Delete '.$tour->name.'?\');" href="'.site_url("admin/tours/delete?id=$tour->id").'" class="table-actions-button ic-table-delete"></a>
					</td>
				</tr>
				';
