...
<div id="header-with-tabs">
	<div class="page-full-width cf">
    	<ul id="tabs" class="fl">
      		...
      		<li><a href="#" class="active-tab dashboard-tab">Edit hotel meta data</a></li>
    	</ul>
								...
								<fieldset>
									...
									<p>
                                        ...
                                        <?php
										  ...
										  echo form_input('meta_title',$hotel->meta_title, 'id="meta_title" class="round default-width-input" autofocus');
                                     ...
                                     <p>
                                        ...
                                        <?php
										  ...
										  echo form_input('url',$hotel->url, 'id="url" class="round default-width-input" autofocus');
                                    ...
                                    <p>
                                        ...
                                        <?php
										  ...
										  echo form_input('meta_keyword',$hotel->meta_keyword, 'id="meta_keyword" class="round default-width-input" autofocus');
                                    ...
                                    <p>
                                        ...
                                        <?php
										  ...
										  echo form_input('meta_description',$hotel->meta_description, 'id="meta_description" class="round" style="width:1000px;" autofocus');
										  
									    ?>
									</p>
									<?php 
									echo form_hidden('id',$hotel->id, set_value('id'));
