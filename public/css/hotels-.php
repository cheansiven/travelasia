        ...
        <table>
          ...
          <div class="blogcontents">
               <h1><?php echo $hotel_title;?></h1>
                ...
                <div class="titlebar tour_bar"> <img src="<?php echo base_url();?>public/images/pointer-01.png" class="imgpointer" alt="Travel Asia"/> hotels <img src="<?php echo base_url();?>public/images/pointer-01.png" class="imgpointer" alt="Travel Asia"/> </div>
            	<?php
